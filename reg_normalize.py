...
while True:
    ...
    if result1 :
        ...
        aSyscall_Record.serialno=result1.group(1)
        aSyscall_Record.thread_id=result1.group(3)
        aSyscall_Record.thread_name=result1.group(5)
        aSyscall_Record.syscall_name=result1.group(8)
        aSyscall_Record.syscall_param=result1.group(10)
        aSyscall_Record.syscall_ret_val=result1.group(14)
        aSyscall_Record.syscall_ret_val_info=result1.group(20)
        aSyscall_Record.errno=result1.group(23)
        aSyscall_Record.error_info=result1.group(26)        
    elif result2: 
        print("exit_with_syscall")
        print(result2.group(1),result2.group(3),result2.group(5),result2.group(10))
        print("line:",line)
        aSyscall_Record.type=2  
        aSyscall_Record.serialno=result2.group(1)
        aSyscall_Record.thread_id=result2.group(3)
        aSyscall_Record.thread_name=result2.group(5)
        aSyscall_Record.exit_with_code=result2.group(10)        
    elif result3: 
        ...
        aSyscall_Record.serialno=result3.group(1)
        aSyscall_Record.thread_id=result3.group(3)
        aSyscall_Record.thread_name=result3.group(5)
        aSyscall_Record.signal_name=result3.group(10)
        aSyscall_Record.signal_param=result3.group(14)      
    elif result4: 
        print("detach_syscall")
        print(result4.group(1),result4.group(3),result4.group(5),result4.group(8))
        print("line:",line)
        aSyscall_Record.type=4  
        aSyscall_Record.serialno=result4.group(1)
        aSyscall_Record.thread_id=result4.group(3)
        aSyscall_Record.thread_name=result4.group(5)
        aSyscall_Record.syscall_name=result4.group(8)       
    else: 
        print("error pattern")
        print(line)
