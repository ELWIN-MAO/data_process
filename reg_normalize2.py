...
plus_info_ptn=r'(\d+)(\s*,\s*)(\d+)(\s*,\s*)(\d+)(\s*,\s*)(([^,\s]+\s*)+)(\s*,\s*)(\+\+\+)([^\(\)]+)(\+\+\+)'
...
while True:
    ...
    result2=plus_info_ptn_cmpiled.match(line)
...
#        print("line:",line)
        ...
        aSyscall_Record.plus_info="\""+translate(result2.group(11)).strip()+"\""        
    elif result3: 
